...
<div aria-label="breadcrumb" class="py-1 font-size-14" style="background-color: #FAFAFA !important;">
	<div class="container">
		<ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('categoria-productos') }}" class="text-decoration-none font-size-13">Productos</a></li>
                    ...
                    <ul class="p-0" style="list-style: none;">
                        @foreach ($subcategories as $c)
                            <li class="py-2 @if($c->id == $subCategory->id) active @endif" > 
                                <a href="#" class="toggle d-block p-2 text-decoration-none  text-decoration-none text-blue-dark font-size-14 d-inline-block @if($c->id == $subCategory->id) text-danger @endif">{{$c->name}}</a>
