...
@section('content_header')
    <div class="d-flex">
        ...
        <a href="{{ route('ituhielo-product.content') }}" class="btn btn-sm btn-primary">ver</a>
    </div>
@stop
@section('content')
@includeIf('administrator.partials.mensaje-exitoso')
@includeIf('administrator.partials.mensaje-error')
<form action="{{ route('ituhielo-product.content.update') }}" method="post" enctype="multipart/form-data" class="card card-primary">
    @method('put')
    @csrf
...
@section('js')
    ...
    <script src="{{ asset('js/admin/ituhielo-product/product.js') }}"></script>
@stop
